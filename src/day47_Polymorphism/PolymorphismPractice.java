...
import day38_Inheritance_MethodOverriding.carTask.BMW;
import day38_Inheritance_MethodOverriding.carTask.Car;
import day38_Inheritance_MethodOverriding.carTask.Tesla;
import day38_Inheritance_MethodOverriding.carTask.Toyota;
...
public class PolymorphismPractice {
    ...
    public static void main(String[] args) {
        ...
        for (Car eachCar:cars) {                       //we can do this  conditions with single if method
        ...
        Car carWithHigherMileage= cars[0],
            carWithLowestMileage= cars[0];


        for (Car eachCar : cars) {
            if(eachCar.miles>carWithHigherMileage.miles){
                carWithHigherMileage=eachCar;
            }
        ...
        System.out.println("carWithHigherMileage = " + carWithHigherMileage);
