...
public class Castings {
    ...
    public static void main(String[] args) {
        ...
        byte num1 = (byte)averageScore;// explicit casting is mandotory here
        short num2 = (short) averageScore;// explicit casting is mandotory here
        int num3 = (int) averageScore;// explicit casting is mandotory here
        float num4 = averageScore;// which casting? -ıt is neither of them.
        double num5 = averageScore;// implicit is done automatically
