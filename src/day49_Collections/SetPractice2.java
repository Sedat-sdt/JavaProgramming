...
public class SetPractice2 {
    ...
    public static void main(String[] args) {
        ...
        String [] name ={"Ahmet", "Ahmet", "John", "James", "Breanna", "Shay", "Ahmet"};
        Set<String> names = new LinkedHashSet<>(Arrays.asList(name));   // Array to SET
        //System.out.println(names.get(3));    //SET does not have index, only keeps order

        //Set<String> names = new LinkedHashSet<>();
        //names.addAll(Arrays.asList("Ahmet", "Ahmet", "John", "James", "Breanna", "Shay", "Ahmet"));

        System.out.println( names.toArray(new String[0])[2] );  //SET to ARRAY

        System.out.println( new ArrayList<>(names).get(4)  );   //SET to ARRAYLİST
        ...
        //FOR EACH LOOP is applicable for all of the data structures(Array,ArrayList,Set.....even to the MAP)
